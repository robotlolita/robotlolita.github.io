...
** 3.5. Data-parents
Data-parents are a step-further from the mixin approach, but instead of
providing new actions to an object, they provide data initialisation, in
the same manner a constructor function would do.




** 3.6. Resending messages
