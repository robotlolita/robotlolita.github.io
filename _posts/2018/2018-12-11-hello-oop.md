...
Someone shared [Charles Scalfani](https://medium.com/u/85310ec460ee)’s [article about why they were abandoning Object Oriented Programming](https://medium.com/@cscalfani/goodbye-object-oriented-programming-a59cda4c0e53) and moving to Functional Programming:
...
None of these concepts is exclusive to OOP, but that’s where people are most likely to encounter them. I also would not say that any of these are “pillars of OOP”, but a lot of people seem to think that some are, and I feel like this is one of those cases where the descriptive nature of language makes things very confusing, by assigning the same term to different notions of a concept, or even different concepts altogether!
